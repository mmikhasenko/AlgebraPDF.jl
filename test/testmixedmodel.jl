...
g1 = Normalized(FGauss(Ext(μ1= 2.1, σ1=0.7)), (-3, 3))
g2 = Normalized(FGauss((μ2=-0.7, σ2=0.7)), (-3, 3))
mm0 = MixedModel([g1, g2], (f1=0.33,))
mm1 = MixedModel([g1, g2], Ext(f1=0.33))

mm0(1.1), func(mm0,1.1)

@testset "Call mixed model" begin
